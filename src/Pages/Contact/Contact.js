    ...
    return(
      <div className = 'contact-us'>
        ...
        <div className = 'email-container'>
          <svg className = 'email-logo' width="139" height="84" viewBox="0 0 139 84" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className = 'phone-container'>
          <svg className = 'phone-logo' width="117" height="121" viewBox="0 0 117 121" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className = 'facebook-container'>
          <svg className = 'facebook-logo' width="122" height="110" viewBox="0 0 122 110" fill="none" xmlns="http://www.w3.org/2000/svg">
